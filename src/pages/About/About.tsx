...
import { calender, mail, person, map, phone, brain, leftarrow, user2, blockchain, devops, aws, app, data } from "../../assets/icons/icon";
import image from "../../assets/img/rahulkp.jpeg";
import Certificates from "./Certificate";
import WorkExperience from "./workExperience";

const interests = [
  { image: brain, text: "AI & Machine Learning" },
  { image: devops, text: "DevOps" },
  { image: aws, text: "AWS" },
  { image: data, text: "Data Structures" },
  { image: app, text: "Mobile Application Development" },
  { image: blockchain, text: "Blockchain" },
];
...
<nav className="border-b border-gray-300">
      <div className="py-6 px-5 md:px-10 xl:px-24 max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-3 md:justify-between md:items-center">
        {/* Back to Home */}
        <button
  ...
  <section className="px-5 md:px-10 xl:px-24 max-w-7xl mx-auto w-full flex flex-col gap-16 md:gap-20 mt-12 md:mt-20">
      {/* Biography Section */}
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">Biography</h1>
        <p className="text-lg md:text-xl bg-yellow-300 font-[600] rounded-xl px-3 py-1 -rotate-10">
          Hello there!!
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 lg:gap-24 xl:gap-32 w-full">
          {[
      ...
      >
        {/* Left Side */}
        <div className="flex-col flex gap-10 flex-1">
        ...
        >
          <img
            src={image}
            className="w-full max-w-xs sm:max-w-sm md:max-w-md xl:max-w-lg rounded-xl shadow-lg"
            alt="Profile"
          />
        </motion.div>
      </motion.div>
